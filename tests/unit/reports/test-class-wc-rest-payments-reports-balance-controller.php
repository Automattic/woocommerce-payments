...
class WC_REST_Payments_Reports_Balance_Controller_Test extends WCPAY_UnitTestCase {
	...
	public function set_up() {
		...
		$this->mock_api_client = $this
			...
			->setMethods( [ 'get_reports_balance_summary' ] )
			->getMock();
	...
	public function test_get_balance_summary_forwards_api_client_result_verbatim() {
		...
		$this->mock_api_client
			->expects( $this->once() )
			->method( 'get_reports_balance_summary' )
			->with( '2024-03-01T00:00:00', '2024-03-31T23:59:59', 'usd' )
			->willReturn( $fixture );
