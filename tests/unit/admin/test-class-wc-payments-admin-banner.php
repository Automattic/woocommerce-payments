...
class WC_Payments_Admin_Banner_Test extends WCPAY_UnitTestCase {
	...
	/**
	 * Creates a WC_Payments_Admin_Banner instance with all conditions eligible
	 * to show the Post-KYC activation notice, using fresh mocks so individual
	 * tests can configure each condition independently without stubbing
	 * conflicts.
	 */
