...
class List_Documents_Test extends WCPAY_UnitTestCase {
	...
	public function test_list_documents_request_has_default_sort_params() {
		$request = new List_Documents( $this->mock_api_client, $this->mock_wc_payments_http_client );
	...
	public function test_list_documents_request_from_rest_request_uses_default_sort_params_when_omitted() {
