...
class Level3ServiceTest extends WCPAY_UnitTestCase {
	...
	public function test_full_level3_data() {
		...
		$this->mock_account->method( 'get_account_country' )->willReturn( Country_Codes::UNITED_STATES );
	...
	public function test_non_us_customer_level_3_data() {
		...
		$this->mock_account->method( 'get_account_country' )->willReturn( Country_Codes::CANADA );
