...
class WC_Payment_Gateway_WCPay_Test extends WP_UnitTestCase {
	...
	public function test_form_fields_grouped_settings_enabled() {
		...
		$this->assertEquals( [ 'buy', 'donate', 'only-icon', 'book' ], array_keys( $form_fields['payment_request_button_type']['options'] ) );
