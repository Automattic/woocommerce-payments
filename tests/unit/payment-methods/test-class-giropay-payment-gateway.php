<?php
/**
 * Class Giropay_Payment_Gateway_Test
 ...
 */
class Giropay_Payment_Gateway_Test extends WP_UnitTestCase {
	/**
	 * System under test.
	 *
	...
	public function setUp() {
		...
		$this->mock_wcpay_gateway = $this->getMockBuilder( Giropay_Payment_Gateway::class )
			->setConstructorArgs(
				[
	...
	public function test_intent_status_requires_action_logged_out_user() {
		...
		$this->assertEquals( 'giropay_redirect_url', $result['redirect'] );
	}
}
