...
var_dump( class_exists( Automattic\Jetpack\Connection\Rest_Authentication::class ) ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_var_dump
var_dump( class_exists( MyCLabs\Enum\Enum::class ) ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.error_log_var_dump
