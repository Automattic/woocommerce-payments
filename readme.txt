...
== Changelog ==
 ...
 = 7.2.6 - 2022-10-12 =
 * Add - Support Platform Checkout from Checkout Blocks.<br/>* Fix - Fix fatal error with call to MultiCurrency/Compatibility::convert_order_prices method.<br/>* Fix - The ellipsis menu is now readable and we can dismiss the task in the "Things to do" task list from Payments > Overview page<br/>* Update - Update formatCurrency to decode HTML entities for rendering currency symbols.<br/>* Dev - Bump minimum required version of WooCommerce to 6.8 to support L2 policy<br/>* Dev - changed WooPay otp url
