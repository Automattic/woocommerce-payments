 ...
 * Add - Support Platform Checkout from Checkout Blocks. CONTRIBUTING.md README.md SECURITY.md apple-developer-merchantid-domain-association assets babel.config.js bin changelog changelog.txt client composer.json composer.lock default.env docker docker-compose.yml docs i18n includes jsconfig.json languages license.txt lint-staged.config.js package-lock.json package.json phpcs-compat.xml.dist phpcs.xml.dist phpunit.xml.dist psalm-baseline.xml psalm-loader.php psalm.xml readme.txt renovate.json tasks templates tests tsconfig.json webpack.config.js woocommerce-payments.php wordpress-org-assets Fix - Fix fatal error with call to MultiCurrency/Compatibility::convert_order_prices method. CONTRIBUTING.md README.md SECURITY.md apple-developer-merchantid-domain-association assets babel.config.js bin changelog changelog.txt client composer.json composer.lock default.env docker docker-compose.yml docs i18n includes jsconfig.json languages license.txt lint-staged.config.js package-lock.json package.json phpcs-compat.xml.dist phpcs.xml.dist phpunit.xml.dist psalm-baseline.xml psalm-loader.php psalm.xml readme.txt renovate.json tasks templates tests tsconfig.json webpack.config.js woocommerce-payments.php wordpress-org-assets Fix - The ellipsis menu is now readable and we can dismiss the task in the "Things to do" task list from Payments > Overview page CONTRIBUTING.md README.md SECURITY.md apple-developer-merchantid-domain-association assets babel.config.js bin changelog changelog.txt client composer.json composer.lock default.env docker docker-compose.yml docs i18n includes jsconfig.json languages license.txt lint-staged.config.js package-lock.json package.json phpcs-compat.xml.dist phpcs.xml.dist phpunit.xml.dist psalm-baseline.xml psalm-loader.php psalm.xml readme.txt renovate.json tasks templates tests tsconfig.json webpack.config.js woocommerce-payments.php wordpress-org-assets Update - Update formatCurrency to decode HTML entities for rendering currency symbols. CONTRIBUTING.md README.md SECURITY.md apple-developer-merchantid-domain-association assets babel.config.js bin changelog changelog.txt client composer.json composer.lock default.env docker docker-compose.yml docs i18n includes jsconfig.json languages license.txt lint-staged.config.js package-lock.json package.json phpcs-compat.xml.dist phpcs.xml.dist phpunit.xml.dist psalm-baseline.xml psalm-loader.php psalm.xml readme.txt renovate.json tasks templates tests tsconfig.json webpack.config.js woocommerce-payments.php wordpress-org-assets Dev - Bump minimum required version of WooCommerce to 6.8 to support L2 policy CONTRIBUTING.md README.md SECURITY.md apple-developer-merchantid-domain-association assets babel.config.js bin changelog changelog.txt client composer.json composer.lock default.env docker docker-compose.yml docs i18n includes jsconfig.json languages license.txt lint-staged.config.js package-lock.json package.json phpcs-compat.xml.dist phpcs.xml.dist phpunit.xml.dist psalm-baseline.xml psalm-loader.php psalm.xml readme.txt renovate.json tasks templates tests tsconfig.json webpack.config.js woocommerce-payments.php wordpress-org-assets Dev - changed WooPay otp url
