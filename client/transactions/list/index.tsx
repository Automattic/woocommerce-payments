...
function sum5( v1: number, v2: number, v3?: number, v4?: number ): number {
...
function getVolume5( dimension: IDimension3D ): number; // Definition 1
function getVolume5( width: number ): number; // Definition 2
function getVolume5( width: number, height: number, depth: number ): number; // Definition 3
function getVolume5( ...args: any[] ): number {
	if ( args.length == 1 ) {
		if ( typeof args[ 0 ] == 'number' ) {
			// Use Definition 1
			return args[ 0 ] * args[ 0 ] * args[ 0 ];
...
function function_overload_ex1_test4() {
	var volume1 = getVolume( 10 ); // 1000
	var volume2 = getVolume( { width: 10, height: 20, depth: 30 } ); // 6000
	var volume3 = getVolume( 5, 10, 15 ); // 750
...
function getName4( person: IStudent | IWorker ): string {
	// Union Type Arg
	var p = person as IStudent;
	if ( p.studentName ) {
		return p.studentName;
...
function function_union_type_args_ex1_test4() {
	var student = { studentId: 1, studentName: 'Tom' };
	var worker = { workerId: 2, workerName: 'Jerry' };
...
function concat44( s1: string, s2: string, s3?: string ): string {
	if ( s3 ) {
		return s1 + s2 + s3;
	}
	return s1 + s2;
}
function sum4( v1: number, v2: number, v3?: number, v4?: number ): number {
	return v1 + v2 + ( v3 ?? 0 ) + ( v4 ?? 0 );
}
function function_optional_args_ex1_test4() {
	var result1 = concat( 'One', 'Two' );
	console.log( `result1: ${ result1 }` );
	var result2 = concat( 'One', 'Two', 'Three' );
	console.log( `result2: ${ result2 }` );
...
function getVolume3( dimension: IDimension3D ): number; // Definition 1
function getVolume3( width: number ): number; // Definition 2
function getVolume3( width: number, height: number, depth: number ): number; // Definition 3
function getVolume3( ...args: any[] ): number {
	if ( args.length == 1 ) {
		if ( typeof args[ 0 ] == 'number' ) {
			// Use Definition 1
			return args[ 0 ] * args[ 0 ] * args[ 0 ];
...
function function_overload_ex1_test3() {
	var volume1 = getVolume( 10 ); // 1000
	var volume2 = getVolume( { width: 10, height: 20, depth: 30 } ); // 6000
	var volume3 = getVolume( 5, 10, 15 ); // 750
...
function getName3( person: IStudent | IWorker ): string {
	// Union Type Arg
	var p = person as IStudent;
	if ( p.studentName ) {
		return p.studentName;
...
function function_union_type_args_ex1_test3() {
	var student = { studentId: 1, studentName: 'Tom' };
	var worker = { workerId: 2, workerName: 'Jerry' };
...
function function_optional_args_ex1_test3() {
	var result1 = concat( 'One', 'Two' );
	console.log( `result1: ${ result1 }` );
	var result2 = concat( 'One', 'Two', 'Three' );
	console.log( `result2: ${ result2 }` );
...
function getVolume2( dimension: IDimension3D ): number; // Definition 1
function getVolume2( width: number ): number; // Definition 2
function getVolume2( width: number, height: number, depth: number ): number; // Definition 3
function getVolume2( ...args: any[] ): number {
	if ( args.length == 1 ) {
		if ( typeof args[ 0 ] == 'number' ) {
			// Use Definition 1
			return args[ 0 ] * args[ 0 ] * args[ 0 ];
...
function function_overload_ex1_test2() {
	var volume1 = getVolume( 10 ); // 1000
	var volume2 = getVolume( { width: 10, height: 20, depth: 30 } ); // 6000
	var volume3 = getVolume( 5, 10, 15 ); // 750
...
function getName2( person: IStudent | IWorker ): string {
	// Union Type Arg
	var p = person as IStudent;
	if ( p.studentName ) {
		return p.studentName;
...
function function_union_type_args_ex1_test2() {
	var student = { studentId: 1, studentName: 'Tom' };
	var worker = { workerId: 2, workerName: 'Jerry' };
...
function concat2( s1: string, s2: string, s3?: string ): string {
	if ( s3 ) {
		return s1 + s2 + s3;
	}
	return s1 + s2;
}
function sum2( v1: number, v2: number, v3?: number, v4?: number ): number {
	return v1 + v2 + ( v3 ?? 0 ) + ( v4 ?? 0 );
}
function function_optional_args_ex1_test2() {
	var result1 = concat( 'One', 'Two' );
	console.log( `result1: ${ result1 }` );
	var result2 = concat( 'One', 'Two', 'Three' );
	console.log( `result2: ${ result2 }` );
