...
export const getRiskReviewColumns = (): Column[] =>
	[
		{
			key: 'created',
...
export const getRiskReviewRowContent = (
	data: Authorization
...
export const getRiskReviewColumnsStructure = (
	data: Authorization,
	columns: Column[]
): TableCardBodyColumn[] => {
	const content = getRiskReviewRowContent( data );
