...
import { getRiskReviewColumns, getRiskReviewColumnsStructure } from './columns';

export const RiskReviewList = (): JSX.Element => {
	const columnsToDisplay = getRiskReviewColumns();
	const {
	...
	const rows = authorizations.map( ( auth ) =>
		getRiskReviewColumnsStructure( auth, columnsToDisplay )
	);
