 ...
 */
import { SelectControl, TextareaControl } from 'wcpay/components/wp-components-wrapped';
    ...
    <section className="wcpay-dispute-evidence-product-details">
      ...
      <div className="wcpay-dispute-evidence-product-details__field-group">
        <SelectControl
          ...
          help={__('First select the kind of product you fulfilled.', 'woocommerce-payments')}
          value={productType}
          onChange={onProductTypeChange}
          options={[
            { label: __('Physical products', 'woocommerce-payments'), value: 'physical_product' },
            { label: __('Digital products', 'woocommerce-payments'), value: 'digital_product_or_service' },
      ...
      <div className="wcpay-dispute-evidence-product-details__field-group">
        <TextareaControl
          ...
          help={__('Please make sure this is an accurate description of the product.', 'woocommerce-payments')}
          value={ productDescription }
          onChange={ ( value ) => onProductDescriptionChange( value ) }
          disabled={readOnly}
        />
      </div>
    </section>
