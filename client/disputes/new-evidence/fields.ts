...
export type FieldType = 'text' | 'textarea' | 'file' | 'date';
 ...
 *
 * @param reason      Dispute reason for which to present fields.
 * @param productType Product type for which to present fields.
 *
 * @return Sections of fields.
 */
export default function getEvidenceFields(
