...
import { ExternalLink, Panel, PanelBody } from '@wordpress/components';
...
export const DisputeStepsExpandable: React.FC< Props > = ( {
	dispute,
	customer,
	chargeCreated,
} ) => {
	...
	return (
		<Panel className="dispute-steps-expandable">
			<PanelBody
				title={ __( 'Steps to resolve', 'woocommerce-payments' ) }
				initialOpen={ true }
				className="dispute-steps-expandable__panel"
			>
				<ol className="dispute-steps-expandable__steps">
					<li>
						{ customer?.email
...
export const InquiryStepsExpandable: React.FC< Props > = ( {
	dispute,
	customer,
	chargeCreated,
	isDefendable,
	...
	return (
		<Panel className="dispute-steps-expandable">
			<PanelBody
				...
				className="dispute-steps-expandable__panel"
			>
				<ol className="dispute-steps-expandable__steps">{ steps }</ol>
			</PanelBody>
		</Panel>
	);
};
