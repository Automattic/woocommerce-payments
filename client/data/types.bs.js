...
function make$2(urlOpt, numberOpt, param) {
  ...
  var number = numberOpt !== undefined ? numberOpt : "";
  return {
          url: url,
          number: number
        };
...
function make$5(statusOpt, amountOpt, param) {
...
function make$6(object_Opt, dataOpt, has_moreOpt, total_countOpt, urlOpt, param) {
