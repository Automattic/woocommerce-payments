...
function outcome(json) {
  var match = Json_decode.field("risk_level", Json_decode.string, json);
  var tmp;
  switch (match) {
    case "elevated" :
        tmp = /* Elevated */1;
...
function charge(json) {
  return {
          ...
          created: Json_decode.field("created", Json_decode.$$float, json),
          ...
          order: Json_decode.optional((function (param) {
                  return Json_decode.field("order", order, param);
                }), json),
