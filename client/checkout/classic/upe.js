 ...
 */
import './style.scss';
import { PAYMENT_METHOD_NAME_UPE } from '../constants.js';
...
jQuery( function ( $ ) {
	...
	// Only attempt to mount the element once that section of the page has loaded. We can use the updated_checkout
	...
	const wcpayPaymentMethods = [ PAYMENT_METHOD_NAME_UPE ];
