...
describe( 'Stepper', () => {
	...
	it( 'shows the next step when the "Next" button is clicked', async () => {
		render(
			<Stepper>
				<TestStep name="Step 1" />
				<TestStep name="Step 2" />
	...
	it( 'calls onComplete when there are no more steps forward', async () => {
	...
	it( 'shows the prev step when the "Prev" button is clicked', async () => {
		render(
			<Stepper>
				<TestStep name="Step 1" />
				<TestStep name="Step 2" />
	...
	it( 'calls onExit when there are no more steps back', async () => {
	...
	it( 'calls onStepChange for both next and prev', async () => {
