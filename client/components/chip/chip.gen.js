...
const $$toRE454541293 = {"Primary": 0, "Light": 1, "Warning": 2, "Alert": 3, "Default": 4};
...
export const make = function chip(Arg1) {
  const $props = {chipType:(Arg1.chipType == null ? undefined : $$toRE454541293[Arg1.chipType]), isCompat:Arg1.isCompat, message:Arg1.message};
