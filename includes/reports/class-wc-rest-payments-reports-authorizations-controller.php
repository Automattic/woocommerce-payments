...
class WC_REST_Payments_Reports_Authorizations_Controller extends WC_Payments_REST_Controller {
	...
	public function get_collection_params() {
		return [
			...
			'status_is'            => [
				'description' => __( 'Filter transactions where status is a specific value.', 'woocommerce-payments' ),
				'type'        => 'string',
				'required'    => false,
			],
			'status_is_not'        => [
				'description' => __( 'Filter transactions where status is not a specific value.', 'woocommerce-payments' ),
				'type'        => 'string',
				'required'    => false,
			],
			'source_device_is'     => [
			...
			'currency_is'          => [
				'description' => __( 'Filter transactions based on currency.', 'woocommerce-payments' ),
				'type'        => 'string',
				'required'    => false,
			],
			'currency_is_not'      => [
	...
	public function get_item_schema() {
		$schema = [
			...
			'properties' => [
				...
				'transaction_id'    => [
					'description' => __( 'Associated transaction id for specific charge.', 'woocommerce-payments' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
				],
				'channel'           => [
				...
				'payment_method'    => [
					...
					'properties'  => [
						...
						'id'   => [
							'description' => __( 'The payment method ID used to create the authorization.', 'woocommerce-payments' ),
							'type'        => 'string',
							'context'     => [ 'view' ],
						],
					],
				...
				'is_captured'       => [
					'description' => __( 'Indicates is authorization captured or not.', 'woocommerce-payments' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
				],
				'currency'          => [
				...
				'amount_captured'   => [
					'description' => __( 'The captured amount of the authorization.', 'woocommerce-payments' ),
					'type'        => 'number',
					'context'     => [ 'view' ],
				],
				'amount_refunded'   => [
					'description' => __( 'The refunded amount of the authorization.', 'woocommerce-payments' ),
					'type'        => 'number',
					'context'     => [ 'view' ],
				],
				'fees'              => [
				...
				'payment_intent_id' => [
					'description' => __( 'Associated payment intent.', 'woocommerce-payments' ),
					'type'        => 'string',
					'context'     => [ 'view' ],
				],
			],
