...
class WC_Payments_UPE_Checkout extends WC_Payments_Checkout {
	...
	public function get_payment_fields_js_config() {
		...
		if ( WC_Payments_Features::is_upe_legacy_enabled() ) {
			...
			$payment_fields['upePaymentIntentData'] = false; // $this->gateway->get_payment_intent_data_from_session();
			$payment_fields['upeSetupIntentData']   = false; // $this->gateway->get_setup_intent_data_from_session();
		}
	...
	public function get_enabled_payment_method_config() {
		...
		foreach ( $enabled_payment_methods as $payment_method_id ) {
			...
			if ( WC_Payments_Features::is_upe_split_enabled() ) {
				$settings[ $payment_method_id ]['upePaymentIntentData'] = false; //$this->gateway->get_payment_intent_data_from_session( $payment_method_id );
				$settings[ $payment_method_id ]['upeSetupIntentData']   = false; // $this->gateway->get_setup_intent_data_from_session( $payment_method_id );
