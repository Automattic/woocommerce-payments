...
/**
 * Credit Card Payment Gateway inheriting from UPE Gateway.
 */
class CC_UPE_Payment_Gateway extends UPE_Payment_Gateway {
	...
	public function __construct(
		...
		$payment_method  = new CC_Payment_Method( $token_service );
