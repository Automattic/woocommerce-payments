...
class Tracking {
	...
	private function get_currency_data_array( Currency $currency ): array {
		...
		$is_zero_decimal = 0 === $currency->get_number_of_decimals();
		...
		$price_rounding = $currency->get_default_rounding() === $price_rounding ? $price_rounding . ' (default)' : $price_rounding;
		...
		$additional_data = [
			'number_of_decimals' => $currency->get_number_of_decimals(),
