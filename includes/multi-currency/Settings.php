		...
		if ( '' === $current_section ) {
			$settings = apply_filters(
				...
				[
					...
					[
						'title'         => __( 'Store settings', 'woocommerce-payments' ),
						'desc'          => __( 'Automatically switch customers to their local currency if it is enabled above. Requires Geolocation for the default customer location in WooCommerce General settings.', 'woocommerce-payments' ),
