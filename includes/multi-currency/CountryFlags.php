...
class CountryFlags {
	...
	const EMOJI_COUNTRIES_FLAGS = [
		...
		'IM'                                            => '🇮🇲',
		Country_Codes::INDIA                            => '🇮🇳',
		Country_Codes::BRITISH_INDIAN_OCEAN_TERRITORY   => '🇮🇴',
		Country_Codes::IRAQ                             => '🇮🇶',
		Country_Codes::IRAN                             => '🇮🇷',
		...
		Country_Codes::TAJIKISTAN                       => '🇹🇯',
		'TK'                                            => '🇹🇰',
		Country_Codes::EAST_TIMOR                       => '🇹🇱',
		Country_Codes::TURKMENISTAN                     => '🇹🇲',
		Country_Codes::TUNISIA                          => '🇹🇳',
		Country_Codes::TONGA                            => '🇹🇴',
		Country_Codes::TURKEY                           => '🇹🇷',
		Country_Codes::TRINIDAD_AND_TOBAGO              => '🇹🇹',
		Country_Codes::TUVALU                           => '🇹🇻',
		...
		Country_Codes::URUGUAY                          => '🇺🇾',
		Country_Codes::UZBEKISTAN                       => '🇺🇿',
		Country_Codes::VATICAN_CITY                     => '🇻🇦',
		Country_Codes::SAINT_VINCENT_AND_THE_GRENADINES => '🇻🇨',
		Country_Codes::VENEZUELA                        => '🇻🇪',
		'VG'                                            => '🇻🇬',
		'VI'                                            => '🇻🇮',
		Country_Codes::VIETNAM                          => '🇻🇳',
		Country_Codes::VANUATU                          => '🇻🇺',
		'WF'                                            => '🇼🇫',
		Country_Codes::SAMOA                            => '🇼🇸',
