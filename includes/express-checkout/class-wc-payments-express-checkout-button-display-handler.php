...
class WC_Payments_Express_Checkout_Button_Display_Handler {
	...
	public function init() {
		...
		if ( $is_woopay_enabled || $is_payment_request_enabled ) {
			add_action( 'wc_ajax_wcpay_ece_add_to_cart', [ $this->express_checkout_ajax_handler, 'ajax_add_to_cart' ] );
			add_action( 'wc_ajax_wcpay_ece_empty_cart', [ $this->express_checkout_ajax_handler, 'ajax_empty_cart' ] );
