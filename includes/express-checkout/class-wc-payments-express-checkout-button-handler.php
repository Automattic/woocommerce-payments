...
class WC_Payments_Express_Checkout_Button_Handler {
	...
	public function is_account_creation_possible() {
		...
		// Express Checkout cannot collect a custom username. A password, however, can be
		// generated by WooCommerce when the Store API creates the customer account.
		return (
		...
		return array_merge(
			...
			apply_filters(
				...
				[
					...
					// Product page (no cart yet) and pay-for-order (order API has no cart extension).
