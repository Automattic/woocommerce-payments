	...
	public static function get_localized_messages() {
		return apply_filters(
			...
			[
				...
				'invalid_expiry_month'                  => __( 'The card\'s expiration month is invalid.', 'woocommerce-payments' ),
				'invalid_expiry_year'                   => __( 'The card\'s expiration year is invalid.', 'woocommerce-payments' ),
				'invalid_cvc'                           => __( 'The card\'s security code is invalid.', 'woocommerce-payments' ),
				'incorrect_number'                      => __( 'The card number is incorrect.', 'woocommerce-payments' ),
				'incomplete_number'                     => __( 'The card number is incomplete.', 'woocommerce-payments' ),
				'incomplete_cvc'                        => __( 'The card\'s security code is incomplete.', 'woocommerce-payments' ),
				'incomplete_expiry'                     => __( 'The card\'s expiration date is incomplete.', 'woocommerce-payments' ),
				'expired_card'                          => __( 'The card has expired.', 'woocommerce-payments' ),
				'incorrect_cvc'                         => __( 'The card\'s security code is incorrect.', 'woocommerce-payments' ),
				'postal_code_invalid'                   => __( 'Invalid zip code, please correct and try again.', 'woocommerce-payments' ),
				'invalid_expiry_year_past'              => __( 'The card\'s expiration year is in the past.', 'woocommerce-payments' ),
				'card_declined'                         => __( 'The card was declined.', 'woocommerce-payments' ),
				'missing'                               => __( 'There is no card on a customer that is being charged.', 'woocommerce-payments' ),
				'processing_error'                      => __( 'An error occurred while processing the card.', 'woocommerce-payments' ),
				...
				'insufficient_funds'                    => __( 'The card has insufficient funds.', 'woocommerce-payments' ),
			]
		);
	}
