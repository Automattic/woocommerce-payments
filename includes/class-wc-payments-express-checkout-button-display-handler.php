...
class WC_Payments_Express_Checkout_Button_Display_Handler {
	...
	public function __construct( WC_Payment_Gateway_WCPay $gateway, WC_Payments_Payment_Request_Button_Handler $payment_request_button_handler, WC_Payments_Platform_Checkout_Button_Handler $platform_checkout_button_handler ) {
		...
		$is_woopay_express_checkout_enabled = $this->platform_checkout_button_handler->is_woopay_enabled();
		$is_payment_request_enabled         = 'yes' === $this->gateway->get_option( 'payment_request' );

		if ( $is_woopay_express_checkout_enabled || $is_payment_request_enabled ) {
	...
	public function display_express_checkout_separator_if_necessary() {
		$should_show_woopay          = $this->platform_checkout_button_handler->should_show_platform_checkout_button();
