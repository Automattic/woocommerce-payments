...
final class Charge extends Data_Transfer_Object implements \JsonSerializable
{
	/**
	 * Charge ID
	 *
	 ...
	 * @param Address     $billing_details        - Billing information associated with the payment method at the time of the transaction.
	 ...
	 * @param Order       $order                  - Charge order object.
	 ...
	 * @param bool        $captured               - Is captured.
	 */
