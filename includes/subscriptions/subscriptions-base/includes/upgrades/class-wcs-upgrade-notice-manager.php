...
class WCS_Upgrade_Notice_Manager {
	...
	public static function maybe_show_admin_notice() {
		...
		$notice->set_content_template( 'update-welcome-notice.php', WC_Subscriptions_Base_Plugin::instance()->get_base_plugin_directory() . '/includes/upgrades/templates/', array(
			'version'  => $version,
			'features' => $features,
		) );
