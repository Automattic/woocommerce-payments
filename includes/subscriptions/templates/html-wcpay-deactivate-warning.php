			...
			<section class="wc-backbone-modal-main" role="main">
				...
				<article>
					<p>
						<?php
							printf(
								// translators: $1 $2 $3 are placeholders are opening and closing HTML link tags, linking to documentation. $4 $5 placeholders are opening and closing strong HTML tags.
