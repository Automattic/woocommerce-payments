		...
		<tbody>
			<tr>
				...
				<td class="help">
					<?php
					/* translators: %s: WooPayments */
					echo wc_help_tip( sprintf( __( 'The current version of the %s extension.', 'woocommerce-payments' ), 'WooPayments' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output.
					?>
				</td>
			...
			<tr>
				...
				<td class="help">
					<?php
					/* translators: %s: WooPayments */
					echo wc_help_tip( sprintf( __( 'Can your store connect securely to wordpress.com? Without a proper WPCOM connection %s can\'t function!', 'woocommerce-payments' ), 'WooPayments' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output.
					?>
				</td>
			...
			<?php if ( $this->http->is_connected() ) : ?>
				<tr>
					...
					<td class="help"><?php echo wc_help_tip( __( 'The corresponding wordpress.com blog ID for this store.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
				...
				<tr>
					...
					<td class="help"><?php echo wc_help_tip( __( 'The merchant account ID you are currently using to process payments with.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
				...
				if ( $this->gateway->is_connected() ) :
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'Is the payment gateway ready and enabled for use on your store?', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'Whether the payment gateway has test payments enabled or not.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'What payment methods are enabled for the store.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
					...
					<tr>
						...
						<td class="help">
							<?php
							/* translators: %s: WooPayments */
							echo wc_help_tip( sprintf( __( 'WooPay is not available, as a %s feature, or the store is not yet eligible.', 'woocommerce-payments' ), 'WooPayments' ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output.
							?>
						</td>
...
<?php else : ?>
					<tr>
						<td data-export-label="WooPay"><?php esc_html_e( 'WooPay Express Checkout', 'woocommerce-payments' ); ?>:</td>
						<td class="help"><?php echo wc_help_tip( __( 'Whether the new WooPay Express Checkout is enabled or not.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
						<td>
						<?php
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'Whether there are extensions active that are have known incompatibilities with the functioning of the new WooPay Express Checkout.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
...
<?php endif; ?>
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'Whether the store has Payment Request enabled or not.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
						<td>
						<?php
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'The current fraud protection level the payment gateway is using.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'The advanced fraud protection filters currently enabled.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
						<td>
							<?php
							// Process the list.
...
<?php endif; ?>
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'Whether the store has the Multi-currency feature enabled or not.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'Whether the store has the Public Key Encryption feature enabled or not.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'Whether the store has the Auth & Capture feature enabled or not.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
					...
					<tr>
						...
						<td class="help"><?php echo wc_help_tip( __( 'Whether the tax documents section is enabled or not.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
...
<?php endif; // Connected to WPCOM. ?>
			<tr>
				...
				<td class="help"><?php echo wc_help_tip( __( 'Whether debug logging is enabled and working or not.', 'woocommerce-payments' ) ); /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- wc_help_tip escapes the output. */ ?></td>
