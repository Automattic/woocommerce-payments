	...
	public function get_settings(): WP_REST_Response {
		return new WP_REST_Response(
			[
				...
				'platform_checkout_button_size'       => $this->wcpay_gateway->get_option( 'platform_checkout_button_size' ),
				'platform_checkout_button_type'       => $this->wcpay_gateway->get_option( 'platform_checkout_button_type' ),
				'platform_checkout_button_theme'      => $this->wcpay_gateway->get_option( 'platform_checkout_button_theme' ),
